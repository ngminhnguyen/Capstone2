...
const inputVariants = cva(
    "flex h-10 w-full border rounded-sm px-3 py-2 text-xl disabled:cursor-not-allowed disabled:opacity-50 file:border-0 file:rounded-sm file:text-xl file:font-medium file:text-primary file:mr-5  focus-visible:outline-0",
    {
        variants: {
            variant: {
                default:
